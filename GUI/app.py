...
from app.tabs.vacuum import vacuumControlWidget
...
class MainWindow(QtWidgets.QWidget):
    ...
    def build(self) -> None:
        ...
        #vacuum widget
        self.vacuum_control_widget = vacuumControlWidget(self)
        self.vacuum_control_widget.build()
        self.vacuum_control_widget.pop_in.connect(self.tabs.pop_in)
        self.tabs.addTab(self.vacuum_control_widget, self.vacuum_control_widget.windowTitle())

        self.vacuum_control_widget.emit_message.connect(
            self.main_connection_widget.mqtt_connection_widget.mqtt_client.publish
        )
